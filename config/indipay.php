...
return [
    ...
    */
    ...
    'ccavenue' => [                         // CCAvenue Parameters
        'merchantId'  => env('INDIPAY_MERCHANT_ID', '258265'),
        'accessCode'  => env('INDIPAY_ACCESS_CODE', 'AVUA92HE10BD32AUDB'),
        'workingKey' => env('INDIPAY_WORKING_KEY', 'C9A91C295D0362030EB6D176EA213849'),

        // Should be route address for url() function
        'redirectUrl' => env('INDIPAY_REDIRECT_URL', 'parents/ccavenuePayment/response'),
        'cancelUrl' => env('INDIPAY_CANCEL_URL', 'parents/ccavenuePayment/response'),
    ...
    'remove_csrf_check' => [
                'parents/ccavenuePayment/response',
    ],
